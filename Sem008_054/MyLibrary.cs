...
public static class MyLibrary
{
    ...
    // Метод, сортирующий массив вещественных чисел 
    // (по возрастанию или по убыванию в зависимости от значения флажка desc)
    // На вход подается двумерный массив вещественных чисел,
    // элементы которого нужно отсортировать построчно по столбцам
